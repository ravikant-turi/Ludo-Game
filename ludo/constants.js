...
export const STEP_LENGTH = 6.66;//  100%/15

export const PLAYERS = ['P1', 'P2'];

export const BASE_POSITIONS = {
    P1: [500, 501, 502, 503],//goti ka number
    P2: [600, 601, 602, 603],
}

export const START_POSITIONS = {
    // start stump blue and green
    P1: 0,
    P2: 26
}

export const HOME_ENTRANCE = {
    // goti lal hone ka number
...
// is number k baad goti lal hone k leye andar jayega
